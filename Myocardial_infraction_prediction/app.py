...
def predictAction():
    if request.method == 'POST':
        ...
        model=pd.read_pickle('C:/Users/admin/Myocardial_infraction_prediction/Stroke-prediction/strokenew.pkl')
        ...
        str=""
        if result==0:
            str = name + ", you will not have a risk of Myocardial infraction 😀"
        else:
            str = name + ",you will have a risk of Myocardial infraction 😔"
